...
Report bugs at https://github.com/NERC-CEH/hydrometlib/issues.
...
Hydrometeorology Calculation Library could always use more documentation, whether as part of the official docs, local
...
https://github.com/NERC-CEH/hydrometlib/issues.
...
Ready to contribute? Here's how to set up hydrometlib for local development.

1. Fork the hydrometlib repo on GitHub.

1. Clone your fork locally:

   ```sh
   git clone git@github.com:your_name_here/hydrometlib.git
   ```
