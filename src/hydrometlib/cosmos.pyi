...
def correct_counts(
    cts_mod: np.ndarray,
    factor_inten: np.ndarray,
    factor_pa: np.ndarray,
    factor_q: np.ndarray,
) -> np.ndarray: ...
@overload
def d86(
...
def soil_moisture_index(
    cosmos_vwc: pl.Expr,
    wilting_point: pl.Expr,
    field_capacity: pl.Expr,
    saturation: pl.Expr,
) -> pl.Expr: ...
@overload
...
def soil_moisture_index(
    cosmos_vwc: pl.Series,
    wilting_point: pl.Series,
    field_capacity: pl.Series,
    saturation: pl.Series,
) -> pl.Series: ...
@overload
def soil_moisture_index(
    cosmos_vwc: pd.Series,
    wilting_point: pd.Series,
    field_capacity: pd.Series,
